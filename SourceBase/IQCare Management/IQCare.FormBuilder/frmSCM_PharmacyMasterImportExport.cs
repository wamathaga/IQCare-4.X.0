...
namespace IQCare.FormBuilder
{
    public partial class frmSCM_PharmacyMasterImportExport : Form
    {
        ...
        private void frmSCM_PharmacyMasterImportExport_Load(object sender, EventArgs e)
        {
            ...
            txtfile.Text = "";
            if (GblIQCare.HasFunctionRight(ApplicationAccess.FBSCMConfiguration, FunctionAccess.Add, GblIQCare.dtUserRight) == false)
            {
                btnImport.Enabled = false;
            }

            if (GblIQCare.HasFunctionRight(ApplicationAccess.FBSCMConfiguration, FunctionAccess.Update, GblIQCare.dtUserRight) == false)
            {
