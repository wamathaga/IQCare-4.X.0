<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Site.Master" CodeBehind="Transition.aspx.cs"
    Inherits="HIVCE.Presentation.Transition" %>

<asp:Content ID="Data" ContentPlaceHolderID="SiteContent" runat="Server">
    <script src="<%=ResolveUrl("Scripts/Transition.js") %>" type="text/javascript"></script>
