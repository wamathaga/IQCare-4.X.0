...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        //$('#ctl00_IQCareContentPlaceHolder_TAB_2062_TXTDT-CareEndedDate-DTL_PATIENTCAREENDED-999976-2062').datepicker({ autoclose: true });
        $(".datePicker").datepicker({ autoclose: true });
    });
    function SetTextInTextBox2(ctlrId) {
        //alert(ctlrId);
        //var n1 = "ctl00_IQCareContentPlaceHolder_TAB_2062_TXTDT-CareEndedDate-DTL_PATIENTCAREENDED-999976-2062";
        //$('#ctl00_IQCareContentPlaceHolder_TAB_2062_TXTDT-CareEndedDate-DTL_PATIENTCAREENDED-999976-2062').datepicker({ autoclose: true });
    }
...
<div class="content-wrapper">
      ...
      <div class="box box-primary box-solid">
       <div class="box-header">
        <h3 class="box-title" id="Header" runat="server"></h3>
       </div>
        <!-- /.box-header -->
 ...
 <label class="control-label required" for="VisitDate" id="lblvisitdate"><asp:Label ID="Label1" runat="server" Text="Visit Date:"></asp:Label></label> 
             </div>
 ...
 <label for="VisitDate" class="control-label">Signature:</label>
 </div>
 ...
 <div class="col-md-2 col-sm-12 col-xs-12 form-group">
 <label class="control-label">System Date:</label>
 </div>
 <div class="col-md-4 col-sm-12 col-xs-12 form-group">
 <asp:TextBox ID="txtSysDate" runat="server" CssClass="form-control" Width="120"></asp:TextBox>
 </div>
