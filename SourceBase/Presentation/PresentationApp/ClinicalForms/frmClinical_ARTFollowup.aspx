    ...
    <div class="content-wrapper">
      ...
      <div class="box box-primary box-solid">
       <div class="box-header">
        <h3 class="box-title">ART Follow-up Form</h3>
       </div>
        <!-- /.box-header -->
...
<div style="float: left"><input id="txtTestCD4Results" style="width:100px;" readonly="readonly" runat="server" size="4" class="form-control" /></div>
<div style="float: left;margin-top:5px;"><span class="smallerlabel">c/mm<sup>3</sup></span></div>
    ...
    <div class="row">
    <br />
    <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label style="margin-left:5px;">CD4 Prior to Starting ARVs:</label></div>
    <div class="col-md-3 col-sm-12 col-xs-12 form-group">
    <div style="width: 100%; margin: 0px auto;">
<div style="float: left"><asp:TextBox ID="txtpriorARVsCD4" runat="server" Width="100" MaxLength="4" CssClass="form-control"></asp:TextBox></div>
<div style="float: left"><span class="smallerlabel">c/mm<sup>3</sup></span></div>
</div></div>
    
    <div class="col-md-1 col-sm-12 col-xs-12 form-group"><label>Date:</label></div>
   ...
   <div class="form-group">
    ...
    <div class="row">
   <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label>Last Viral Load:</label></div>
   <div class="col-md-3 col-sm-12 col-xs-12 form-group">
   <div style="width: 100%; margin: 0px auto;">
<div style="float: left"><input id="txtmostRecentViralLoad" style="width:100px;" readonly="readonly" runat="server" size="4" class="form-control" /></div>
<div style="float: left"><span class="smallerlabel">c/ml</span></div>
</div> </div>
   <div class="col-md-1 col-sm-12 col-xs-12 form-group"><label>Date:</label></div>
   <div class="col-md-5 col-sm-12 col-xs-12 form-group">
   <div class="form-group">
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" class="form-control pull-left" id="txtmostRecentViralLoadDate" clientidmode="Static"
                                                        runat="server" data-date-format="dd-M-yyyy" style="width:110px;"/>
                                                </div>
                                            </div>
   </div>
 ...
 <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             ...
             <div class="form-group">
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" class="form-control pull-left" id="txtPrescribedARVStartDate" clientidmode="Static"
                                                        runat="server" data-date-format="dd-M-yyyy" style="width:110px;" maxlength="11" size="8" readonly="readonly"/>
                                                </div>
                                            </div>
             </div>            
    </div>
...
<div style="float: left"><div class="form-group">
                                                <div class="input-group date">
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </div>
...
<div class="row">
<div class="col-md-5 col-sm-12 col-xs-12 form-group">
<label>Number of Doses Missed:</label>
</div>

</div>
<div class="row">
<div class="col-md-3 col-sm-12 col-xs-12 form-group">
<label id="lbldosmissed">Last Week:</label>
</div>
<div class="col-md-3 col-sm-12 col-xs-12 form-group">
<div id="MissedLastWeek" style="display: inline">
<input type="text" id="txtMissedLastWeek" name="MissedLastWeek" size="2" maxlength="4" runat="server" style="width:100px;" class="form-control"/>
 </div>
</div>
<div class="col-md-3 col-sm-12 col-xs-12 form-group">
<input type="checkbox" id="chMissedLastWeeknone" name="MissedLastWeeknone" size="2" runat="server" />
...
<div class="row">
<div class="col-md-3 col-sm-12 col-xs-12 form-group"><label>DOT:</label></div>
<div class="col-md-3 col-sm-12 col-xs-12 form-group">
<asp:TextBox ID="txtNumDOTPerWeek" runat="server" MaxLength="4" Width="100" CssClass="form-control"></asp:TextBox></div>
<div class="col-md-3 col-sm-12 col-xs-12 form-group"><span class="smalllabel">times/week</span></div>
</div>
<div class="row">
<div class="col-md-3 col-sm-12 col-xs-12 form-group"><label>Home Visits:</label></div>
<div class="col-md-3 col-sm-12 col-xs-12 form-group">
<asp:TextBox ID="txtNumHomeVisitsPerWeek" runat="server" MaxLength="4" Width="100" CssClass="form-control"></asp:TextBox>
                                                </div>
<div class="col-md-3 col-sm-12 col-xs-12 form-group">
...
<div class="row">
<div class="col-md-3 col-sm-12 col-xs-12 form-group"><label>Support Group:</label></div>
<div class="col-md-3 col-sm-12 col-xs-12 form-group">
<span><input type="checkbox" id="ckSupportGroup" name="SupportGroup" runat="server" style="vertical-align: top;
                                                margin-left: 6%;" /></span>
</div>
</div>
<div class="row">
<div class="col-md-6 col-sm-12 col-xs-12 form-group"><label>Rx was interrupted(Unintentional):</label></div>
<div class="col-md-2 col-sm-12 col-xs-12 form-group">
...
<input type="text" id="TxtInterruptedNumDays" name="InterruptedNumDays" size="2" class="form-control" style="width:50px" maxlength="3" runat="server" />
</div>
<div style="float: left"><span class="smalllabel"># of days</span></div>
</div>
...
<div class="row">
<div class="col-md-6 col-sm-12 col-xs-12 form-group"><label>Rx was stopped (intentional):</label></div>
<div class="col-md-2 col-sm-12 col-xs-12 form-group">
...
<div style="width: 100%; margin: 0px auto;">
<div style="float: left">
<input type="text" id="txtstoppedNumDays" name="stoppedNumDays" size="2" class="form-control" style="width:50px" maxlength="3" runat="server" /></div>
<div style="float: left">
...
<label>Patient reports taking herbal medications:</label></div>
<div class="col-md-2 col-sm-12 col-xs-12 form-group">
...
<div class="row">
<div class="col-md-5 col-sm-12 col-xs-12 form-group">
<label id="lblreasonmissed">Reason Missed:</label>
</div>
</div>
<div class="row">
...
<div style="float: left" class="supMrgn"><span class="smallerlabel"><label>cm</label></span></div>
    ...
    <div class="col-md-3 col-sm-12 col-xs-12 form-group">
    <div style="width: 100%; margin: 0px auto;">
<div style="float: left" class="supMrgn"><label id="Label2">WT:</label></div>
<div style="float: left">
...
<div class="row">
 <div class="col-md-2 col-sm-12 col-xs-12 form-group">
 <label id="lblassessment">Clinical Assessment:</label>
 </div>
 <div class="col-md-8 col-sm-12 col-xs-12 form-group">
 ...
 <div class="row">
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
 <label id="lblWHO">WHO Stage:</label>
 </div>
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
 <asp:DropDownList ID="ddlWHOStage" runat="server" CssClass="form-control" Style="width:140px;"></asp:DropDownList>
 </div>
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
 <label id="lblWAB">WAB Stage:</label>
 </div>
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
...
<div class="row">
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
 <label id="lblarvplan">ARV Therapy:</label>
 </div>
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
 ...
 <div class="row">
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label class="required">Change Regimen Reason:</label>
             </div>
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label class="required" for="arvTherapyChangeCodeOtherName">Specify:</label>
             </div>
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <input id="txtarvTherapyChangeCodeOtherName" maxlength="20" size="10" class="form-control" name="arvTherapyChangeCodeOtherName" runat="server" />
             </div>   
                    </div>            
    </div>
</div></div>
 ...
 <div class="row">
 <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <label id="lblrARTdate" class="required">Date ART Ended</label>
             </div>
             <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <div class="form-group">
                                                <div class="input-group date">
             ...
             <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                                             <label class="required">Stop Regimen Reason:</label>
             </div>
             <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             ...
             <div class="col-md-1 col-sm-12 col-xs-12 form-group">
             <label class="required right15" for="arvTherapyStopCodeOtherName">Specify:</label>
             </div>
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <input id="txtarvTherapyStopCodeOtherName" maxlength="20" size="10" name="arvTherapyStopCodeOtherName" runat="server" class="form-control" style="width:250px;" />
             </div>    
             </div>               
    </div>
 </div>
...
<div class="row">
 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
             <asp:TextBox ID="txtClinicalNotes" TextMode="MultiLine" Width="99%" runat="server" CssClass="form-control" Style="resize:none;"></asp:TextBox>
             </div>
 ...
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <asp:DropDownList ID="ddlAppReason" runat="server" CssClass="form-control" Width="200"> </asp:DropDownList>
             </div>                      
    </div>
    <div class="row">
 <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <asp:DropDownList ID="ddlCounsellorSignature" runat="server" CssClass="form-control" Width="300"></asp:DropDownList>
             </div>                      
    </div>
    <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
    ...
    <asp:Button ID="btnsave" Text="Save" runat="server" OnClick="btnsave_Click" CssClass="btn btn-primary"
                            ...
                            <asp:Button ID="btnOk" Text="OK" CssClass="btn btn-primary" runat="server"
                            ...
                            <asp:Button ID="theBtnDQ" Text="DQ" CssClass="btn btn-primary" runat="server"
