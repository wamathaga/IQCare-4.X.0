...
<script type="text/javascript">
    ...
    <div class="content-wrapper">
     ...
     <div class="box box-primary box-solid">
      <div class="box-header">
              <h3 class="box-title">MEI Form</h3>
            </div>
             <!-- /.box-header -->
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlFieldVisitType" runat="server" AutoPostBack="true" CssClass="form-control" Width="250" OnSelectedIndexChanged="ddlFieldVisitType_SelectedIndexChanged">
                        </asp:DropDownList>
            </div>
            <div class="col-md-1 col-sm-12 col-xs-12 form-group text-right">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2ClientInformation" runat="server" Style="overflow:hidden;">
                                            <div id="ClientInformation" style="display: none;">
                                             <div class="row">
             <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">LMP:</label>
             </div>
 ...
 onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,3);"/>
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">EDD:</label>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            <div class="form-group">
                                                <div class="input-group date">
  ...
  onfocus="javascript:vDateType='3'" onkeyup="DateFormat(this,this.value,event,false,3);"/>
             ...
             <div class="row">
             <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Age at Mernarche:</label>
             </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            <input type="text" id="txtAgeMernarche" runat="server" style="width: 108px;" maxlength="2" class="form-control"/>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Parity:</label>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlparity" runat="server" CssClass="form-control" Width="150"></asp:DropDownList>
            </div>
             </div>
              <div class="row">
             <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Gravidae:</label>
             </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlGravidae" runat="server" CssClass="form-control" Width="150"></asp:DropDownList>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">
            Gestation:</label>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            <input type="text" id="txtGestation" runat="server" style="width: 40%;" readonly="readonly" class="form-control"/>
            </div>
             </div>
              <div class="row">
             <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">
             <label id="lblVisitNumber" runat="server" class="required margin35">Visit Number:</label>
             </label>
             </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlVisitNumber" runat="server" CssClass="form-control" Width="150"> </asp:DropDownList>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label"></label>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            </div>
             </div>
             ...
             <label for="inputEmail3" class="control-label" style="margin-left:20px;">Did Client receive tetanus toxoid vaccine?</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-5 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlTTVaccine" runat="server" Width="200" CssClass="form-control">
                                                                </asp:DropDownList>
                                                                <textarea id="txtNoTTReason" runat="server" cols="40" rows="1" style="display: none;width:450px;height:50px;" 
                                                                placeholder="Give reason why TT vaccine wasn't issued" class="form-control"></textarea>
            </div>
             </div>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2HTC" runat="server" Style="overflow:hidden;">
                                            <div id="MHT" style="display: none">
                                             <div class="row">
             <div class="col-md-5 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label required">Is client due for HIV Testing?:</label>
             </div>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             ...
             <div id="trHIVTesting1" style="display: none;" class="whitebg">
                                                 <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Previous HIV Status:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlPrevHIVStatus" runat="server" CssClass="form-control" Width="120"></asp:DropDownList>
            </div>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlPrevPointHIVTesting" runat="server" CssClass="form-control" Width="120"></asp:DropDownList>
            </div>
             </div>
             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Date of last HIV Test:</label>
             </div>
            ...
            <div class="form-group">
                                                <div class="input-group date">
                                                    ...
                                                    <input type="text" class="form-control pull-left" id="txtLastHIVTest" clientidmode="Static"
                                                       maxlength="11" size="11" runat="server" data-date-format="dd-M-yyyy" style="width:120px;" onblur="DateFormat(this,this.value,event,false,3)" onkeyup="DateFormat(this,this.value,event,false,3);"
             ...
             <div id="trHIVTesting2" style="display: none" class="whitebg">
              <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Pre test counselling and testing:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><asp:DropDownList ID="ddlPreTestCounselling" runat="server" CssClass="form-control" Width="120"></asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Post test counselling and testing:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><asp:DropDownList ID="ddlPosttestcounselling" runat="server" CssClass="form-control" Width="120"></asp:DropDownList>
            </div>
             </div>
              <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">HIV Test Done Today:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlHIVTestDoneToday" runat="server" CssClass="form-control" Width="120"> </asp:DropDownList>
            </div>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
              ...
              <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Final HIV result:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlFinalHIVResult" runat="server" CssClass="form-control" Width="120"></asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label"></label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2PartnerHIVStatus" runat="server" Style="overflow:hidden;">
                                            <div id="PHS" style="display: none">
                                             <div class="row">
             <div class="col-md-4 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Is Patient accompanied by partner?</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label"></label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            </div>
             </div>
             <div id="pap1" style="display: none">
              <div class="row">
             <div class="col-md-4 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Pre Test Counselling:</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlpartnerPreTestCounselling" runat="server" CssClass="form-control" style="width:150px;"></asp:DropDownList>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">HIV Test done to partner:</label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlHIVTestdonetopartner" runat="server" CssClass="form-control" style="width:150px;"></asp:DropDownList>
            </div>
             </div>
              <div class="row">
             <div class="col-md-4 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Final HIV result for partner:</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlPartnerFinalHIVresult" runat="server" CssClass="form-control" style="width:150px;"> </asp:DropDownList>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label"></label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             ...
             <div id="pap2" style="display: none">
              <div class="row">
             <div class="col-md-4 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Post Test Counselling:</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlPartnerPostTestCounselling" runat="server" CssClass="form-control" style="width:150px;"> </asp:DropDownList>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Is the couple discordant?</label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <input id="rdodiscordantcoupleYes" type="radio" value="Yes" runat="server" name="discordantcouple" />
              ...
              <div class="row">
             <div class="col-md-4 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Partners DNA PCR result?:</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlPartnerDNA" runat="server" CssClass="form-control" style="width:150px;"></asp:DropDownList>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label"></label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2FamilyHIVinformation" runat="server" Style="overflow:hidden;">
                                            <div id="FHI" style="display: none">
                                             <div class="row">
             <div class="col-md-4 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Has the family information form been filled?</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">
            Have other members of the family been tested for HIV?
            </label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlFamilybeentestedHIV" runat="server" CssClass="form-control" style="width:150px;"></asp:DropDownList>
            </div>
             </div>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2PsychosocialHistoryGBV" runat="server" Style="overflow:hidden;">
                                            <div id="PHG" style="display: none">
                                             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Historic Mental Health:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlHMHealth" onchange="fnotherHMHealth();" runat="server" CssClass="form-control" Width="180"> </asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Current Mental Health:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlCMHealth" onchange="fnotherCMHealth();" runat="server" CssClass="form-control" Width="180"></asp:DropDownList>
            </div>
             </div>
              <div class="row" >
            ...
            <asp:TextBox ID="txtCMentalHealth" runat="server" CssClass="form-control"></asp:TextBox>
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Experienced any GBV?</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group"><input id="rdoExperienceanyGBVYes" type="radio" value="Yes" runat="server" name="ExperienceanyGBV" />
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">GBV Experienced:</label>
            </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
            <div id="divGBVExperienced" class="customdivbordermultiselect">
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Substance abuse?</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Substance Abused:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2BirthandGeneralPlan" runat="server" Style="overflow:hidden;">
                                            <div id="BGP" style="display: none">
                                             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label required">Preffered mode of delivery:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlPreferedmodeofdelivery" runat="server" CssClass="form-control" Width="180"></asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label required">Preffered Site of Delivery:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtPreferedSiteDelivery" runat="server" CssClass="form-control" Width="180"></asp:TextBox>
            </div>
             </div>
              <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Comments - Additional notes?</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtPreferedSiteDeliveryAdditionalnotes" runat="server" TextMode="MultiLine" CssClass="form-control" 
            Style="height: 100px; vertical-align: middle;resize:none;" Width="100%"></asp:TextBox>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Referral:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <div id="div20" class="customdivbordermultiselect" style="margin-left:-25px;">
            <asp:Panel ID="pnlReferral" runat="server"></asp:Panel>
                                                                        </div>
            </div>
             </div>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2PreviousthreePregnanciesHistory" runat="server" Style="overflow:hidden;">
                                            <div id="PTPH" style="display: none">
                                             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Year of Delivery:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtYrofDelivery" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Place of Delivery:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtPlaceofDelivery" runat="server" CssClass="form-control"></asp:TextBox>
              ...
              <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Maturity :</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlMaturityweeks" runat="server" CssClass="form-control" Width="130"></asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Labour duration (hrs)</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtLabourduratioin" runat="server" CssClass="form-control"></asp:TextBox>
              ...
              <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Mode of Delivery:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlModeofDelivery" runat="server" CssClass="form-control" Width="180"></asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Gender</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlGenderofBaby" runat="server" CssClass="form-control" Width="140"></asp:DropDownList>
            </div>
             </div>
              <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Fate:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlFateofBaby" runat="server" CssClass="form-control" Width="140"></asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label"></label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             ...
             <label for="inputEmail3" class="control-label required">Maternal Blood Group:</label>
             </div>
             <div class="col-md-6 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlMaternalBloodGroup" runat="server" CssClass="form-control" Width="120"></asp:DropDownList>
            </div>
             </div>
             <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label required">Rhesus Factor :</label>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlRhesusFactor" runat="server" CssClass="form-control" Width="120"> <asp:ListItem Text="Select" Value="0"></asp:ListItem>
              ...
              <div class="row">
              <div class="col-md-6 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Partners Blood Group:</label>
             </div>
            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlPartnersBloodGroup" runat="server" CssClass="form-control" Width="120"> </asp:DropDownList>
            </div>
              </div>
             <div class="row">
             
            <div class="col-md-6 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">History Of Twins :</label>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12 form-group"><input id="rdoHistoryOfTwinsYes" type="radio" value="Yes" runat="server" name="HistoryOfTwins" />
             ...
             <div class="row">
             <div class="col-md-6 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">History of Blood Transfusion:</label>
             </div>
            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
           ...
           <div class="row">
            ...
            <div class="form-group">
             ...
             <div class="row">
             <label for="inputEmail3" class="control-label">History of Chronic Illness:</label>
             </div>
             <div class="row">
            ...
            <asp:TextBox ID="txtPresentingcomplaints" TextMode="MultiLine" runat="server" Width="100%"
             placeholder="Please Enter Detail about Presenting Complaints" CssClass="form-control" Style="resize:none;"></asp:TextBox>
            </div>
                                ...
                                <tr>
                                    <td>
                                        <asp:Panel ID="pnl2PhysicalExaminationFindings" runat="server" Style="overflow:hidden;">
                                            ...
                                            <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">General Appearance:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtGeneralAppearance" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">CVS:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtCVS" runat="server" CssClass="form-control"></asp:TextBox>
             ...
             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label"> RS:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><asp:TextBox ID="txtRS" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Breasts:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtBreasts" runat="server" CssClass="form-control"></asp:TextBox>
             ...
             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Abdomen:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtAbdomen" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Vaginal Examination:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtVaginalExamination" runat="server" CssClass="form-control"></asp:TextBox>
             ...
             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Discharge:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><asp:TextBox ID="txtdischarge" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <label for="inputEmail3" class="control-label">Pallor:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><asp:TextBox ID="txtPallor" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
             </div>
             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Fundal Height:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><asp:TextBox ID="txtPresentation" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Foetal Heart Rate:</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtFoetalHeartRate" runat="server" CssClass="form-control"></asp:TextBox>
             ...
             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Oedema :</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                                                                ...
                                                                                <div class="mid" style="height: auto; overflow: auto">
                                                                                    <div id="div29" class="GridView whitebg">
                                                                                        <asp:GridView ID="grdLatestResults" runat="server" Width="100%" BorderWidth="0px"
                                                                                            AutoGenerateColumns="False" GridLines="None" CssClass="table table-bordered table-hover" CellPadding="0">                                                                                           
                                                                                        </asp:GridView>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
 ...
 onkeyup="DateFormat(this,this.value,event,false,3);" onfocus="javascript:vDateType='3'"/>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Admitted to ward?</label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <input id="rdoAdmittedtowardyes" type="radio" value="Yes" runat="server" name="Admittedtoward" />
              ...
              <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Specify Ward Admitted:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlDiagnosisandPlanWardAdmitted" runat="server" CssClass="form-control" Width="180">
            </asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label"></label>
            </div>
                                ...
                                <tr>
                                    <td>
                                        <asp:Panel ID="pnl2ManagementHIVPositiveClientOtherFacility" runat="server" Style="overflow:hidden;">
                                            ...
                                            <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Mother currently on ARVs:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">
            <label id="Label75" runat="server">Specify current regimen:</label></label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlSpecifyCurrentRegmn" runat="server" onchange="fnotherCurrentRegimen();" CssClass="form-control" Width="200"></asp:DropDownList>
            </div>
             </div>
             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <label for="inputEmail3" class="control-label">
            <label id="Label72" runat="server">Regimen:</label></label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtotherregimen" runat="server"  Width="200" CssClass="form-control"></asp:TextBox>
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">
             <label id="Label76" runat="server">Mother currently on cotrimoxazole:</label></label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <input id="ddlmthroncotrimoxazoleyes" type="radio" value="Yes" runat="server" name="cotrimoxa" />
             <label for="ddlmthroncotrimoxazoleyes">Yes</label>
             <input id="ddlmthroncotrimoxazoleNo" type="radio" value="No" runat="server" name="cotrimoxa" />
             <label for="ddlmthroncotrimoxazoleNo">No</label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">
            <label id="Label77" runat="server">Mother currently on multivitamins:</label></label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <input id="rdoMotherCurrentlyonmultivitaminsyes" type="radio" value="Yes" runat="server" name="MotherCurrentlyonmultivitamins" />
             <label for="rdoMotherCurrentlymultivitaminsYes">Yes</label>
             <input id="rdoMotherCurrentlyonmultivitaminsNo" type="radio" value="No" runat="server" name="MotherCurrentlyonmultivitamins" />
             <label for="rdoMotherCurrentlymultivitaminsNo"> No</label>
            </div>
             </div>
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2Adherence" runat="server" Style="overflow:hidden;">
                                            <div id="Adhrnc" style="display: none">
                                             <div class="row">
             <div class="col-md-4 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Adherence Assessment done:</label>
             </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">Have you missed any doses:</label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            <input id="rdoMissedanydosesYes" type="radio" value="Yes" runat="server" name="Missedanydoses" />
             ...
             <label for="inputEmail3" class="control-label">Barriers to adherence:</label>
             </div>
             </div>
             <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
            <div id="div25" class="customdivbordermultiselect">
             <asp:Panel ID="pnlBarriertoadherence" runat="server"></asp:Panel>
                                                                            </div>
            </div>            
             </div>
             ...
             <label for="inputEmail3" class="control-label">
             <label id="Label94" runat="server" class="margin20">Number of doses missed last month:</label></label>
             </div>
             </div>
             <div class="row">
            <div class="col-md-10 col-sm-12 col-xs-12 form-group">
            ...
            <div id="div24" class="customdivbordermultiselect">
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">
             <label id="Label97" runat="server">Number of Home visits:</label></label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtNofHomevisits" runat="server" CssClass="form-control" Width="200"></asp:TextBox>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group"><label for="inputEmail3" class="control-label">
             <label id="Label98" runat="server">Prioritise Home Visits:</label></label>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <input id="rdoPrioritiseHomeVisitYes" type="radio" value="Yes" runat="server" name="PrioritiseHomeVisit" />
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label"> 
             <label id="Label99" runat="server"> DOT:</label></label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                    ...
                                    <td>
                                        <asp:Panel ID="pnl2Pwp" runat="server" Style="overflow:hidden;">
                                            <div id="PWP" style="display: none">
                                             ...
                                             <div class="row">
             <div class="col-md-8 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label required">Have you disclosed your HIV status:</label>
             </div>
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
             ...
             <div id="div26" class="customdivbordermultiselect">
                                             ...
                                             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Additonal Notes:</label>
             </div>
            <div class="col-md-9 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtAdditionalPWPNotes" runat="server" Style="resize:none;" CssClass="form-control" TextMode="MultiLine" Height="60px" Width="90%"></asp:TextBox>
            </div>            
             </div>
             <div class="row">
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Condoms Issued:</label>
             </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                                ...
                                <tr>
                                    <td>
                                        <asp:Panel ID="pnl2TreatmentPlan" runat="server" Style="overflow:hidden;">
                                            ...
                                            <div class="row">
                                             <div class="col-md-8 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label"><label id="lblARTPreparation" runat="server">
                                            ...
                                            <div class="row">
                                             ...
                                             <div class="row">
                                             <div class="col-md-5 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label required"> ARV Regimen:</label>
             </div>
            <div class="col-md-5 col-sm-12 col-xs-12 form-group">
             <asp:DropDownList ID="ddlARVRegimen" runat="server" CssClass="form-control" Width="250"></asp:DropDownList>
            </div>
            </div>
                                                <div class="row">
                                                <div class="col-md-5 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label"><label id="Label105" runat="server">
            ...
            <input id="rdoInfantNVPissuedYes" type="radio" value="Yes" runat="server" name="InfantNVPissued" />
                                                ...
                                                <div class="col-md-5 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label"> 
             <label id="Label107" runat="server" class="required margin5">CTX:</label></label>
             </div>
            <div class="col-md-5 col-sm-12 col-xs-12 form-group">
            <asp:DropDownList ID="ddlCTX" runat="server" onchange="fnotherCTXStopreason();" CssClass="form-control" Width="250"></asp:DropDownList>
            </div>
                                                </div>
                                                <div class="row" id="divctx" style="display: none">
                                                <div class="col-md-5 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Stop reason:</label>
             </div>
            <div class="col-md-5 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtctxstopreason" runat="server" TextMode="SingleLine" CssClass="form-control" Width="250"></asp:TextBox>
            </div>
                                                </div>

                                                <div class="row">
                                                <div class="col-md-5 col-sm-12 col-xs-12 form-group">
             <label for="inputEmail3" class="control-label">Other Management:</label>
             </div>
            <div class="col-md-5 col-sm-12 col-xs-12 form-group">
            <asp:TextBox ID="txtotherMgmt" runat="server" CssClass="form-control" TextMode="MultiLine" Style="vertical-align: middle;resize:none;"></asp:TextBox>
            </div>
                                                </div>
                                            </div>
 ...
 onfocus="javascript:vDateType='3'"/>
            ...
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            <label for="inputEmail3" class="control-label">Admitted to ward?</label>
            </div>
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
            ...
            <asp:DropDownList ID="ddlWardAdmitted" runat="server" CssClass="form-control" Width="180"></asp:DropDownList>
            </div>
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            </div>
             </div>
