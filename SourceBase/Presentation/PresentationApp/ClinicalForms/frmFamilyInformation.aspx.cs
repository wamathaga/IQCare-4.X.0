...
public partial class ClinicalForms_frmFamilyInformation : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (object.Equals(Session["CE"], null))
        {
            Session["CE"] = "false";
        }
    ...
    protected void grdFamily_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        ...
        if (theDT.Rows.Count > 0)
        {
            ...
            if (theDT.Rows[r]["HivStatusID"].ToString() != "")
            {
                ...
                ViewState["HivStatusID"] = theDT.Rows[r]["HivStatusID"].ToString();
            }
