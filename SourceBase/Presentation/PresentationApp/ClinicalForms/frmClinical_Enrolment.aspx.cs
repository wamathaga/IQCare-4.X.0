...
public partial class ClinicalForms_frmClinical_Enrolment : BasePage
{
    ...
    private void BindDropdown(String EmployeeId)
    {
        ...
        //{
            DataView theDV = new DataView(oCommonData.getAllEmployees());
            if (theDV.Table != null)
            {
                ...
                BindUserDropdown(lstenrollmentInterviewerName, Session["AppUserId"].ToString());
            }
        //}
    ...
    protected void Init_Form()
    {
        try
        {
            ...
            if (Convert.ToInt32(ViewState["visitPk"]) == 0)
            {
                ...
                theDV = new DataView(oCommonData.getAllEducation());
                ...
                theDV = new DataView(oCommonData.getAllLPTF());
                theDV.RowFilter = "DeleteFlag=0 and SystemId=1";
                ViewState["LPTF"] = null;
                if (theDV.Table != null)
                {
                ...
                theDV = new DataView(oCommonData.getMSTDecode(9));
                theDV.RowFilter = "DeleteFlag=0 and (SystemID=0 or SystemID=1)";
                if (theDV.Table != null)
                {
                    theDT = (DataTable)theUtils.CreateTableFromDataView(theDV);
                ...
                theDV = new DataView(oCommonData.getAllEmployees());
                ...
                //*****Jayant -- ART Sponser 
                theDV = new DataView(oCommonData.getAllARTSponsor());
                theDV.RowFilter = "Deleteflag=0 and SystemID=1";
                if (theDV.Table != null)
                {
                ...
                theDV = new DataView(oCommonData.getAllHivDisclosure());
                theDV.RowFilter = "Deleteflag=0 and SystemID=1";
                if (theDV.Table != null)
                {
            ...
            if (Convert.ToInt32(ViewState["visitPk"]) > 0)
            {
                ...
                theDV = new DataView(oCommonData.getMSTDecode(10));
                ...
                /*******/
                theDV = new DataView(oCommonData.getMSTDecode(11));
                ...
                /******/
                //HIV Disclosure
                theDV = theDV = new DataView(oCommonData.getAllHivDisclosure());
                theDV.RowFilter = "SystemID=1";
                if (theDV.Table != null)
                {
                    DT_disclosure = (DataTable)theUtils.CreateTableFromDataView(theDV);
