...
.voffset9 { margin-top: 150px; }
      ...
      <div class="box box-primary box-solid">
       ...
       <div class="row">
       <div class="col-md-6"><h3 class="box-title" id="tHeading">Patient Home</h3></div>
       <div class="col-md-6 text-right"><h3 class="box-title" id="lblServiceArea" runat="server">Service Area</h3></div>
       </div>
        ...
        <!-- /.box-header -->
         ...
         <div class="row">
            <div class="col-md-3 col-sm-12 col-xs-12 form-group text-nowrap">
             ...
             <label class="control-label">DOB:</label> <asp:Label ID="lbldob" runat="server"></asp:Label>
             </div>            
             <div class="col-md-1 col-sm-12 col-xs-12 form-group text-nowrap">
             Age: <asp:Label ID="lblage" runat="server"></asp:Label>
             </div>
             <div class="col-md-2 col-sm-12 col-xs-12 form-group text-nowrap">
             <label  class="control-label">Sex:</label> <asp:Label ID="lblgender" runat="server"></asp:Label>
             </div>
...
<asp:Label CssClass="required" ID="lblTechVisited" runat="server" Text="" Visible="false"></asp:Label>
 ...
 <div class="row box-header">
                                         ...
                                         <h5 class="box-title">Clinical Information</h5>
                                         </div> 
 ...
 <div class="col-md-4">
             <label class="control-label lb-sm">Last Recorded WAB:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">WHO Stage:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">Weight:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">Lowest CD4:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">Most Recent CD4:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">Next CD4 Due:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">HCT:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">HB:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">AST:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">CR:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">Syphilis:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">Pregnancy Test:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm"><asp:Label ID="lblnexthivstatuscheck" runat="server" Visible="False" Text="Next HIV Status Check"></asp:Label></label>
             </div>
             <div class="col-md-5">
             <asp:Label ID="lblnexthivscheck" runat="server"  Width="95%" CssClass="control-label aspxlb-sm" Visible="False"></asp:Label>
             </div>             
 </div>
 <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
...
<div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm">Patient Phone:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm"><asp:Label ID="lblShowAddress" runat="server"></asp:Label></label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm"><asp:Label ID="lblEmrContact" runat="server"></asp:Label></label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm"><asp:Label ID="lblEmrPhone" runat="server"></asp:Label></label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title">Family Information</h5>
                                         </div> 
 ...
 <div class="row voffset1">
 <div class="col-md-5">
             <label class="control-label lb-sm">No. of related members enrolled:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-5">
             <label class="control-label lb-sm">No. of related members on ART:</label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row voffset1">
 <div class="col-md-4">
             <label class="control-label lb-sm"><asp:HyperLink ID="hlFamilyInfo" runat="server" CssClass="utility" Visible="False">Family Information</asp:HyperLink></label>
             </div>
             <div class="col-md-5">
 ...
 <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title">Weight and BMI over time</h5>
                                         </div> 
...
<div class="row voffset1" align="center">
 ...
 <div class="row voffset1" align="center">
 <div class="col-md-12">
   <asp:Button ID="btnWeightChart" runat="server" Text="View Larger Graph" OnClick="btnWeightChart_Click" Style="height: 30px;" CssClass="btn btn-primary" />          
             </div>                       
 </div>
 <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title">CD4 Count and Viral Load over time</h5>
                                         </div> 
 ...
 <div class="row voffset1" align="center">
 <div class="col-md-12">
             <asp:Button ID="btnCD4Graph" runat="server" Text="View Larger Graph" OnClick="btnCD4Graph_Click" Style="height: 30px;" CssClass="btn btn-primary" />
             </div>                       
 </div>
 <div class="row voffset1" align="center">
 <div class="col-md-12">
  ...
  <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title"><asp:Label ID="Label1" runat="server" Text="HIV Care Program Costs"></asp:Label></h5>
                                         </div> 
  ...
  <div class="tab-pane" id="tabPatientAdherence">
   <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title"><asp:Label ID="Label2" runat="server" Text="Patient Adherence"></asp:Label></h5>
                                         </div> 
                                     ...
                                     <div class="row voffset1">                                     
                                                 ...
                                                 <div class="grid">
                                                                        <div id="div2" class="gridviewDebitNote whitebg">
                                                                            <asp:GridView ID="grdarvadherence" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="table table-bordered table-hover"
                                                                                GridLines="None" AllowSorting="True" OnDataBound="grdarvadherence_OnRowDataBound"
                                                                                EmptyDataText="No Data Available" OnRowDataBound="grdarvadherence_RowDataBound">
                                                                                <Columns>
                                                                                    <asp:BoundField DataField="OrderedbyDate" HeaderText="Ordered Date" HeaderStyle-Width="25%" ItemStyle-HorizontalAlign="Center"
                                                                                        DataFormatString="{0:dd-MMM-yyyy}" ReadOnly="True"  ItemStyle-Width="25%"/>
                                                                                    <asp:BoundField DataField="DrugName" HeaderText="DrugName" HeaderStyle-Width="38%" ItemStyle-HorizontalAlign="Center"
                                                                                        ReadOnly="True" ItemStyle-Width="40%"/>
                                                                                    <asp:BoundField DataField="OrderedQuantity" HeaderText="Ordered Qty" ReadOnly="True" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <div class="grid">
                                                                        <div id="div3" class="gridviewDebitNote whitebg">
                                                                            <asp:GridView ID="grdCotriadherence" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" Width="100%"
                                                                                GridLines="None" AllowSorting="True" OnDataBound="grdCotriadherence_OnRowDataBound" 
  ...
  <!-- Custom Tabs End -->
         ...
         <div>
                                ...
                                <tr valign="top">
                                    <td style="width: 60%; height: auto">
                                        <asp:MultiView ID="TabView" ActiveViewIndex="0" runat="server">
                                            ...
                                            <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title">PMTCT Identification Information</h5>
                                         </div>                                                         
                                        </div>
                                        <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm"><asp:Label ID="lblanc" runat="server">ANC Number:</asp:Label></label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblancno" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm"><asp:Label ID="lblpmtct" runat="server">PMTCT Number:</asp:Label></label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblpmtctno" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm"><asp:Label ID="lbladmission" runat="server">Admission Number:</asp:Label></label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lbladmissionno" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm"><asp:Label ID="lbloutpatient" runat="server">Outpatient Number:</asp:Label></label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lbloutpatientno" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                     ...
                                     <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title">PMTCT Information</h5>
                                         </div> 
                                                        
                                        </div>
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">LMP</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblLMP" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm">EDD</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblEDD" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">Gestational Age (Weeks)</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblGestAge" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm">Current ARV Prophylaxis Regimen</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblARVProRegimen" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">Current ARV Prophylaxis Start Date</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblARVProStartDate" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm">TB Status</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblTBStatus" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">Partner HIV Status</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblPartnerHIVStatus" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm">Last Visit</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblLastVisit" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                     ...
                                     <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title">Exposed Infant Information</h5>
                                         </div> 
                                                        
                                        </div>
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">Date of Birth (Current Pregnancy)</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblDeliveryDate" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm">Infant Prophylaxis Regimen</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblInfantProphylaxisRegimen" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">Feeding Option</label>
                                                 </div>
                                                 <div class="col-md-2">
             <asp:Label ID="lblFeedingOption" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                     ...
                                     <div class="col-md-12">
                                            ...
                                            <asp:View ID="ViewART" runat="server">
                                                ...
                                                <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title">HIVCare Static Form Identification Information</h5>
                                         </div>                                                         
                                        </div>
                                        <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm"><asp:Label ID="lblenroll" runat="server">Enroll#:</asp:Label></label>
                                                 </div>
                                                 <div class="col-md-2">
                                                 <asp:Label ID="lblptnenrollment" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm"><asp:Label ID="lblClinicNo" runat="server"></asp:Label></label>
                                                 </div>
                                                 <div class="col-md-2">
                                     ...
                                     <div class="row box-header">
                                         <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                         <h5 class="box-title">ART Information</h5>
                                         </div>                                                         
                                        </div>
                                        <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">ART/Palliative Care:</label>
                                                 </div>
                                                 <div class="col-md-2">
                                                 <asp:Label ID="lblprogram" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm">Current ARV Regimen:</label>
                                                 </div>
                                                 <div class="col-md-2">
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">Current ARV Start Date:</label>
                                                 </div>
                                                 <div class="col-md-2">
                                                 <asp:Label ID="lblarvstartdate" runat="server" Width="95%" CssClass="control-label aspxlb-sm"></asp:Label>
                                                 </div> 
                                                   <div class="col-md-4">
                                                 <label class="control-label lb-sm">ARV Start Date At This Facility:</label>
                                                 </div>
                                                 <div class="col-md-2">
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">Historical ART Start Date:</label>
                                                 </div>
                                                 <div class="col-md-2">
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-4">
                                                 <label class="control-label lb-sm">Next Appointment:</label>
                                                 </div>
                                                 <div class="col-md-2">
                                     ...
                                     <div class="row voffset1">
                                     <div class="col-md-12">
                                      <asp:Panel ID="DynControlsARV" runat="server"></asp:Panel>
                                                 </div>
