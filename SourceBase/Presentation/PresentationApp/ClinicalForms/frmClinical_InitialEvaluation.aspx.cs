...
public partial class frmClinical_InitialEvaluation : BasePage, ICallbackEventHandler
{
    ...
    private void Bind_GridMedHistory(DataTable Year)
    {
        ...
        theCol2.ControlStyle.CssClass = "form-control";
        theCol2.ControlStyle.Width = 100;
        ...
        theCol3.ControlStyle.CssClass = "form-control";
        theCol3.ControlStyle.Width = 150;
    ...
    protected void FillDropDowns()
    {
        ...
        try
        {
            ...
            DataView theDV = new DataView(oCommonData.getAllHIVDiseases());
            ...
            if (Convert.ToInt32(Session["PatientVisitId"]) == 0)
            {
                ...
                theDV = new DataView(oCommonData.getAllSymptoms());
                ...
                theDV = new DataView(oCommonData.getAllReasons());
                ...
                //{
                    //theDT = (DataTable)theUtils.CreateTableFromDataView(theDV);
                BindManager.BindCombo(ddappReason, oCommonData.getMSTDecode(26), "Name", "ID");
                  //  theDV.Dispose();
                //}

                //DataTable theMaster = theDS.Tables["Mst_Employee"];
                DataView theDVEmp = new DataView(oCommonData.getAllEmployees());
