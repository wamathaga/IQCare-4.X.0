...
namespace IQCare.Web.Admission
{
    public partial class PatientWardAdmission : System.Web.UI.UserControl
    {
        ...
        public void Rebind()
        {
            ...
            {
                textAdmissionDate.Value = DateTime.Now.ToString("dd-MMM-yyyy");
...
//                });";
        ...
        protected void buttonAdmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(textExpectedDOD.Value.Trim())) expectedDOD = Convert.ToDateTime(textExpectedDOD.Value.Trim());
