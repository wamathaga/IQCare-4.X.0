    ...
    public partial class frmIQToolsQuery : LogPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                textDateTo.Value = endOfMonth.ToString("dd-MMM-yyyy");

                DateTime startOfMonth = new DateTime(today.Year, today.Month, 1);
                //ceStartDate.SelectedDate = startOfMonth;
                textDateFrom.Value = startOfMonth.ToString("dd-MMM-yyyy");
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DateTime dateFrom = Convert.ToDateTime(textDateFrom.Value);
                DateTime dateTo = Convert.ToDateTime(textDateTo.Value);
