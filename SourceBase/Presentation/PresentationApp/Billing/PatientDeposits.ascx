...
<asp:UpdatePanel ID="notificationPanel" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Button ID="btnRaisePopup" runat="server" Text="New Deposit" Style="margin-bottom: 5px;text-align:left;" CssClass="btn btn-primary" Height="30px" Width="11%"/>
        ...
        <asp:Panel ID="divParameters" runat="server" Style="display: none; width: 380px;
            border: solid 0px #3c8dbc; background-color: #fff; z-index: 15000; height:100px; " DefaultButton="btnNewDeposit">
      ...
      <div class="box box-primary box-solid">
       <div class="box-header">
        ...
        <asp:Panel ID="divTitle" runat="server" Style="cursor: move;">
              <label class="control-label">New Cash Deposit</label>                 
            </asp:Panel>
        </h3>
       </div>
        <!-- /.box-header -->
 ...
 <div class="col-md-1 col-sm-12 col-xs-12 form-group">
            <img src="../images/mb_question.gif" alt="" width="32" height="32" />
             ...
             <label class="control-label"><asp:Label ID="lblDepositAmount" runat="server" Text="Deposit Amount"></asp:Label></label>
             </div>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
  <asp:Button ID="btnNewDeposit" runat="server" Text="Save" CssClass="btn btn-primary" Height="30px" Width="23%" Style="text-align:left;" OnClick="btnNewDeposit_Click" />
                <label class="glyphicon glyphicon-floppy-disk" style="margin-left: -5.5%; vertical-align: sub; color: #fff; margin-right: 2%;"></label>
                <asp:Button ID="btnActionCancel" runat="server" Text="Cancel" CssClass="btn btn-primary" Height="30px" Width="23%" Style="text-align:left;" />
	 ...
	 <%--Main Content End--%>
        ...
        <ajaxToolkit:ModalPopupExtender ID="parameterPopup" runat="server" BehaviorID="PDmpeBID01"
            ...
            CancelControlID="btnActionCancel" DropShadow="false" PopupDragHandleControlID="divTitle" Y="20">
 ...
 <div class="col-md-1 col-sm-12 col-xs-12 form-group">
             ...
             <asp:Image ID="imgNotice" runat="server" ImageUrl="~/images/mb_information.gif" Height="32px" Width="32px" /></label>
             </div> 
 ...
 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
             ...
             <label class="glyphicon glyphicon-ok" style="margin-left: -4%; vertical-align: sub; color: #fff; margin-right: 2%;"></label>
             </div>
 </div>
	 <%--Main Content End--%>
         </div>
...
<asp:UpdatePanel ID="divComponent" runat="server" UpdateMode="Conditional">
 ...
 <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <label class="control-label">Date of Last Deposit:</label>
             </div>
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label class="control-label"><asp:Label ID="labelDepositDate" runat="server"></asp:Label></label>
             </div>
             <div class="col-md-6 col-sm-12 col-xs-12 form-group text-right">
               <asp:Button ID="buttonViewTransactions" runat="server" Text="View Transactions"
                                         Enabled="True" OnClick="buttonViewTransactions_Click"
 ...
 <div class="row">
 <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <label class="control-label">Last Amount Deposited:</label>
             </div>
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label class="control-label"> <asp:Label ID="labelDepositedAmount" runat="server"></asp:Label></label>
             </div>
 ...
 <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             ...
             <div class="col-md-3 col-sm-12 col-xs-12 form-group">
             <label class="control-label"><asp:Label ID="labelReceivedBy" runat="server" Height="30px"></asp:Label></label>
             </div>
             <div class="col-md-6 col-sm-12 col-xs-12 form-group">
 ...
 <div class="row">
 <div class="col-md-2 col-sm-12 col-xs-12 form-group">
             <label class="control-label">Total Amount Available:</label>
             </div>
            ...
            <div style="white-space: nowrap; vertical-align: middle; text-align: left">
                                        ...
                                        <span style='display: <%# ShowHideRefund() %>; white-space: nowrap'>
                                            <asp:Button ID="buttonRefund" runat="server" CausesValidation="false" OnClick="btnRefundYes_Click" CommandName="Refund" Text="Return"
                                              ToolTip="Return the available deposit to the client" CssClass="btn btn-primary" Height="30px" Width="9%" Style="text-align:left;"></asp:Button>
                                               <label class="fa fa-undo" style="margin-left: -2%; vertical-align: sub; color: #fff;margin-right: 2%;""></label>
                                              </span>
                                        ...
                                        <asp:Panel ID="pnlRefundPopup" runat="server" Style="display: none; background-color: #FFFFFF;
                                            ...
                                            <div style="padding: 3px;" align="center">
                                                <asp:Button ID="btnRefundYes" runat="server" Text="Return" CssClass="btn btn-primary" Height="30px" Width="25%" Style="text-align:left;"/>
                                                <label class="fa fa-undo" style="margin-left: -5%; vertical-align: sub; color: #fff;margin-right: 2%;""></label>
                                            ...
                                            <div class="mid" style="height: 220px; overflow: auto">
                                                <div id="div-depositGridview" class="GridView whitebg">
                                                    <asp:GridView ID="gridTransaction" runat="server" AllowSorting="False" AutoGenerateColumns="False"
                                                        BorderColor="White" BorderWidth="1px" CellPadding="0" CssClass="table table-bordered table-hover" DataKeyNames="transactionid"
                                                                    ...
                                                                    <div style="white-space: nowrap">
                                                                        <span style='white-space: nowrap'>
                                                                            <asp:Button ID="transactionPrint" runat="server" CausesValidation="false" CommandName="PrintTransaction"
                                                                                Text="Print" CommandArgument="<%# Container.DataItemIndex %>" CssClass="btn btn-primary" Height="30px" Width="9%" Style="text-align:left;"/>
 ...
 <label class="glyphicon glyphicon-remove" style="margin-left: -3%; vertical-align: sub; color: #fff;margin-right: 2%;""></label>
	 ...
	 <%--Main Content End--%>
        ...
        <ajaxToolkit:ModalPopupExtender ID="depositDetailsPopup" runat="server" BehaviorID="PDmpeBID03"
            ...
            CancelControlID="buttonCloseDetails" DropShadow="false" PopupDragHandleControlID="divItemTitle" Y="10">
        </ajaxToolkit:ModalPopupExtender>
    </ContentTemplate>
    <Triggers>
        <asp:AsyncPostBackTrigger ControlID="btnNewDeposit" EventName="Click" />
