            ...
            <center>
                ...
                <form id="frmPrint" name="form1">
                    <p align="center" class="btn">
                        <input type="button" name="cmdPrint" class="btn btn-primary" style="text-align:center; height:30px;width:6%; color:#fff" value="Print" onclick="window.print(); return false;"></input>&nbsp;
                      <label class="glyphicon glyphicon-print" style="margin-left: -3%; margin-right:3%; vertical-align: sub; color: #fff;"></label>
                        <input type="button" name="cmdClose" class="btn btn-primary" style="text-align:center; height:30px;width:6%; color:#fff" value="Close" onclick="window.close()"/>
                      <label class="glyphicon glyphicon-print" style="margin-left: -3%; margin-right:2%; vertical-align: sub; color: #fff;"></label>
                    </p>
                </form>
