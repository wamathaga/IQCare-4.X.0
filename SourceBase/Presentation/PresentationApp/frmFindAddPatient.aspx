                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-7">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                        <asp:DropDownList ID="ddlIdentifier" runat="server" CssClass="form-control" Width="300"
                                                            AutoPostBack="True" OnSelectedIndexChanged="ddlIdentifier_SelectedIndexChanged">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                        <label id="lblidentificationno" class="control-label" runat="server">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                        <asp:DropDownList ID="ddFacility" runat="server" CssClass="form-control" Width="300">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                                        <asp:DropDownList ID="ddlServices" runat="server" CssClass="form-control" Width="300">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                  <div class="row">
                                            ...
                                            <div class="col-xs-5">
                                                ...
                                                <div class="row" id="tdPatientOtherDetails" runat="server">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5 col-sm-12 col-xs-12 form-group">
                                                            <label for="Careendedstatus" class="control-label">
                                        ...
                                        <div class="row" align="center">
                                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                                ...
                                                <span class="glyphicon glyphicon-search" style="margin-left: -2%; vertical-align: middle;
                                                ...
                                                <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add Patient"
                                                    ...
                                                    margin-left: 1%;" /><span id="spanBtnAdd" runat="server" class="glyphicon glyphicon-plus"
                                                        style="margin-left: -3%; vertical-align: middle; color: #fff; margin-right: 1%"></span>
                                                <asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="Back" CssClass="btn btn-primary"
                                                    Height="30px" Width="6%" Style="text-align: left; margin-left: 2%;" />
                                                                ...
                                                                <div class="mid" style="cursor: pointer; height: 420px; overflow: auto; border: 1px solid #666699;">
                                                                    ...
                                                                    <div id="div-gridview" class="whitebg">
                                                                        ...
                                                                        <asp:GridView ID="grdSearchResult" runat="server" EnableViewState="False" Width="100%"
                                                                            ...
                                                                            CellPadding="0" CellSpacing="0" BorderWidth="0" GridLines="None" AllowSorting="True"
                                                                           >
                                                                        </asp:GridView>
                                                                    </div>
