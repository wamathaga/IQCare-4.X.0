<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucCounsellingSession4.ascx.cs"
    Inherits="PresentationApp.Adherence.Controls.ucCounsellingSession4" %>
...
<div id="divPageGroup2" class="box box-default box-solid">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                <input id="chkCaseManager4" name="switch-size" type="checkbox" checked data-size="small"
    ...
    <div class="box box-default box-body">
        <div class="row">
            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                ...
                <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <input type="number" min="1" max="20" id="txtAdherence4" value="None" class="form-control"
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <input type="text" class="form-control" id="dtFilledDate4" placeholder="Date Filled In"
                ...
                <table class="table" style="padding-left: 10px; margin-bottom: 0px;">
                    ...
                    <tr>
                        ...
                        <td style="border-top: 0px; width: 10%">
                            <input id="chkForgotMed4" name="switch-size" type="checkbox" checked data-size="small"
                                data-on-text="Yes" data-off-text="No">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="border-top: 0px; width: 10%">
                            <input id="chkCarelessMed4" name="switch-size" type="checkbox" checked data-size="small"
                                data-on-text="Yes" data-off-text="No">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="border-top: 0px; width: 10%">
                            <input id="chkWorseTakingMed4" name="switch-size" type="checkbox" checked data-size="small"
                                data-on-text="Yes" data-off-text="No">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="border-top: 0px; width: 10%">
                            <input id="chkFeelBetterMed4" name="switch-size" type="checkbox" checked data-size="small"
                                data-on-text="Yes" data-off-text="No">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="border-top: 0px;">
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                    (MMAS-4) Score =
                                    <input id="txtMMAS4Score4" type="text" disabled="disabled" class="form-control" value="0"
                                        style="width: 30%; display: inline;">
                                    / 4
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                                    Adherence Rating:
                                    <input type="text" id="txtMMAS4Rating4" disabled="disabled" value="Good" class="form-control"
                ...
                <div id="divOtherQesAdherence2">
                    <table class="table" style="padding-left: 10px;">
                        <tr>
                            ...
                            <td style="border-top: 0px; width: 10%">
                                <input id="chkYesterdayMed4" name="switch-size" type="checkbox" checked data-size="small"
                                    data-on-text="Yes" data-off-text="No">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 0px; width: 10%">
                                <input id="chkSymptomUnderControl4" name="switch-size" type="checkbox" checked data-size="small"
                                    data-on-text="Yes" data-off-text="No">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 0px; width: 10%">
                                <input id="chkStickingTreatmentPlan4" name="switch-size" type="checkbox" checked
                        ...
                        <tr>
                            <td colspan="2" style="border-top: 0px;">
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                        (MMAS-8) Score =
                                        <input id="txtMMAS8Score4" type="text" disabled="disabled" class="form-control" value="0"
                                            style="width: 30%; display: inline;">
                                        / 8
                                    </div>
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                        Adherence Rating:
                                        <input type="text" id="txtMMAS8Rating4" disabled="disabled" value="None" class="form-control"
                                            style="width: 55%; display: inline;">
                                    </div>
                                    <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                                        <input type="text" id="txtMMAS8Suggestion4" disabled="disabled" value="None" class="form-control"
                                            style="width: 55%; display: inline;">
                                    </div>
                                </div>
                            </td>
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                <input id="chkDiscussViralLoadResult4" name="switch-size" type="checkbox" checked
        ...
        <div class="row">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                <input id="chkSocialEconomicBarrier4" name="switch-size" type="checkbox" checked
                    data-size="small" data-on-text="Yes" data-off-text="No"></div>
        </div>
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                <textarea class="form-control" rows="5" cols="1" id="txtAreaRoutineReminder4" maxlength="1000"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-10 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                <input id="chkReferredOtherServices4" name="switch-size" type="checkbox" checked
                    data-size="small" data-on-text="Yes" data-off-text="No" />
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                <input id="chkAttendAppointment4" name="switch-size" type="checkbox" checked data-size="small"
                    data-on-text="Yes" data-off-text="No" />
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                <textarea class="form-control" cols="1" style="resize: none; width: 90%;" rows="5"
                    id="txtAreaExperience4" maxlength="1000"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-10 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                <input id="chkBenefitHomeVisit4" name="switch-size" type="checkbox" checked data-size="small"
                    data-on-text="Yes" data-off-text="No" />
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                <textarea class="form-control" cols="1" style="resize: none; width: 90%;" rows="5"
                    id="txtAreaAdherence4" maxlength="1000"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-3 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                <input type="text" class="form-control" id="dtFollowupDate4" placeholder="Follow-up Date"
...
<div class="row no-print" align="center">
    <div class="form-group">
        <div class="col-md-12" align="center">
            ...
            <button type="button" class="btn btn-primary" onclick="SaveSession4();" runat="server"
                id="btnSaveCounsellingSession4" clientidmode="Static">
