<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_DrugChanges.ascx.cs" Inherits="PresentationApp.GreenCard.UserControls.UC_DrugChanges" %>
<style type="text/css">
    .label-align
    {
...
<div class="table-responsive well well-sm pre-scrollable" style="max-height:150px">
                     <asp:GridView ID="grdSubsARVs" runat="server" AutoGenerateColumns="False" AllowSorting="true"
                        Width="100%" BorderColor="white" PageIndex="1" BorderWidth="0" GridLines="None" CssClass="table table-striped table-bordered table-hover"
