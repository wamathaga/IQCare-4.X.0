...
<div class="box box-primary">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
            <button type="button" class="btn btn-primary" onclick="window.open('<%= ResolveUrl("~/ClinicalForms/frmPatientWaitingList.aspx") %>');">
                    Add Patient to Waiting List<span class="glyphicon glyphicon-pencil" style="padding-left: 5px;"></span></button>
                <button type="button" class="btn btn-primary" onclick="window.open('<%= ResolveUrl("~/frmWaitingList.aspx") %>');">
                    Waiting List<span class="glyphicon glyphicon-pencil" style="padding-left: 5px;"></span></button>
                <div class="col-md-1 col-sm-12 col-xs-12 form-group">
                    Signature:
                </div>
                <div class="col-md-5 col-sm-12 col-xs-12 form-group">
...
<div class="row no-print" align="center">
    <div class="form-group">
        <div class="col-md-12" align="center">
            <button type="button" class="btn btn-primary" onclick="SaveTriageData();" runat="server"
